...
impl HelloTriangleApplication {
    ...
    fn cleanup_swap_chain(&mut self) {
        unsafe {
            ...
            self.device
                .as_ref()
                .unwrap()
                .destroy_image_view(self.color_image_view.unwrap(), None);
            self.device
                .as_ref()
                .unwrap()
                .destroy_image(self.color_image.unwrap(), None);
            self.device
                .as_ref()
                .unwrap()
                .free_memory(self.color_image_memory.unwrap(), None);
    ...
    fn create_color_resources(&mut self) {
        let color_format = self.swap_chain_image_format.unwrap();
        ...
        self.color_image_view =
            Some(self.create_image_view(image, color_format, vk::ImageAspectFlags::COLOR, 1));

        self.color_image = Some(image);
        self.color_image_memory = Some(image_memory);
    }
    ...
    fn get_max_usable_sample_count(&mut self) -> vk::SampleCountFlags {
        ...
        match counts {
            Some(vk::SampleCountFlags::TYPE_64) => vk::SampleCountFlags::TYPE_64,
            Some(vk::SampleCountFlags::TYPE_32) => vk::SampleCountFlags::TYPE_32,
            Some(vk::SampleCountFlags::TYPE_16) => vk::SampleCountFlags::TYPE_16,
            Some(vk::SampleCountFlags::TYPE_8) => vk::SampleCountFlags::TYPE_8,
            Some(vk::SampleCountFlags::TYPE_4) => vk::SampleCountFlags::TYPE_4,
            Some(vk::SampleCountFlags::TYPE_2) => vk::SampleCountFlags::TYPE_2,
