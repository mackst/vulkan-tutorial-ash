...
use ash::{
    ...
    vk::{self, AccessFlags, DebugUtilsMessengerEXT, SurfaceFormatKHR},
...
impl HelloTriangleApplication {
    ...
    fn create_graphics_pipeline(&mut self) {
        let vert_shader_module = self.create_shader_module("09_shader_base_vert.spv".to_owned());
        let frag_shader_module = self.create_shader_module("09_shader_base_frag.spv".to_owned());
    ...
    fn create_command_buffer(&mut self) {
        ...
        self.command_buffer = Some(command_buffers[0]);
    }
